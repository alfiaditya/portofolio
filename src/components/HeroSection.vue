<template>
    <section class="relative w-full" data-aos="zoom-in-up">
        <div class="absolute top-0 inset-x-0 flex items-start">
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">Alfi</span>😁
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">I am a fresh graduate excited to pursue a career as a full stack developer. I enjoy taking on new challenges and am always open to fresh opportunities to grow and learn.</p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max lg:max-0">
                        ...
                        <button class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <div class="svg-container">
                                <svg class="download-icon" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M1 17V18C1 18.7956 1.31607 19.5587 1.87868 20.1213C2.44129 20.6839 3.20435 21 4 21H16C16.7956 21 15.5587 20.6839 16.1213 20.1213C16.6839 19.5587 17 18.7956 17 18V17H1Z" stroke="#F59E0B" stroke-width="2" storkenecap="round" />
                                </svg>
                                <div class="download-loaded text-white hidden"></div>
                            </div>
                            <a href="@/assets/CV.pdf" download="CV.pdf" class="pl-2 text-primary">Download resume</a>
                            </div>
                        </button>
                    </div>
                </div>
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-16 rounded-full shadow-lg border border-primary">
                            <img src="@/assets/fotoku.jpg" alt="Hero pic" width="500" height="auto" loading="lazy" 
